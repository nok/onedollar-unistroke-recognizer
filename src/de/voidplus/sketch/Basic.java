...
public class Basic extends PApplet {
	...
	public void detectCircle(float x, float y){
		println("# Circle # X: "+x+"  Y:"+y);
	}
	public void detectTriangle(float x, float y){
	...
	public static void main(String args[]){
		PApplet.main(new String[] { "de.voidplus.sketch.Basic" });
	}
}