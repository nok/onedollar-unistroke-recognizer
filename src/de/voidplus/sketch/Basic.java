...
public class Basic extends PApplet {
	...
	public void foobar( float x, float y){
		println("# X: "+x+"  Y:"+y);
	}
	
	public void mousePressed(){
		one.start(100);
		one.bind(100, "triangle", "foobar");
	}
